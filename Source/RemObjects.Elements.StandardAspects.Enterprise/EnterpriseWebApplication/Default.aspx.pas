...
type
  ...
  protected 
    method SomeMethod;
  public
    [aspect:RemObjects.Elements.StandardAspects.Enterprise.Aspects.Logging(EnterpriseConstants.loggingCategory)]
    [aspect:RemObjects.Elements.StandardAspects.Enterprise.Aspects.LoggingException(EnterpriseConstants.policyName)]
